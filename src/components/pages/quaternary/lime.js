...
// Function to generate shades of Lime
const generateShades = (steps) => {
  const shades = new Map(); // Using a Map to store unique shades
  for (let i = 0; i < steps; i++) {
    const hue = 75; // Hue value for Lime (75 degrees on the color wheel)
...
const LimeShades = () => {
  ...
  return (
    <div className="p-5 mt-10 relative">
      {/* Title Section */}
      <h1 className="text-2xl font-bold text-center mb-1">Unique Shades of Lime</h1>
