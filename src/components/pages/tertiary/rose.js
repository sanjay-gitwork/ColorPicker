...
// Function to generate unique shades of Rose
const generateShades = (steps) => {
  const shades = new Map();
  for (let i = 0; i < steps; i++) {
    const hue = 330; // Rose hue
...
const RoseShades = () => {
  ...
  return (
    <div className="p-5 mt-10 relative">
      <h1 className="text-2xl font-bold text-center mb-1">Unique Shades of Rose</h1>
