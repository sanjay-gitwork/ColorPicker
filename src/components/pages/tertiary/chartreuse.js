...
// Function to generate shades of Chartreuse
const generateShades = (steps) => {
  const shades = new Map(); // Using a Map to store unique shades
  for (let i = 0; i < steps; i++) {
    const hue = 90; // Hue value for Chartreuse (90 degrees on the color wheel)
...
const ChartreuseShades = () => {
  ...
  return (
    <div className="p-5 relative">
      {/* Title Section */}
      <h1 className="text-2xl font-bold text-center mb-4">Unique Shades of Chartreuse</h1>
