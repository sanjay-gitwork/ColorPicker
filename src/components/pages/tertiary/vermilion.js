...
// Function to generate shades of Vermilion
const generateShades = (steps) => {
  const shades = new Map(); // Using a Map to store unique shades
  for (let i = 0; i < steps; i++) {
    const hue = 15; // Hue value for Vermilion (15 degrees on the color wheel)
...
const VermilionShades = () => {
  ...
  return (
    <div className="p-5 relative">
      {/* Title Section */}
      <h1 className="text-2xl font-bold text-center mb-4">Unique Shades of Vermilion</h1>
...
export default VermilionShades;
