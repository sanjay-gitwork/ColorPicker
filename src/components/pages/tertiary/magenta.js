...
// Function to generate shades of Magenta
const generateShades = (steps) => {
  const shades = new Map(); // Using a Map to store unique shades
  for (let i = 0; i < steps; i++) {
    const hue = 300; // Hue value for Magenta (300 degrees on the color wheel)
...
const MagentaShades = () => {
  ...
  return (
    <div className="p-5 relative">
      {/* Title Section */}
      <h1 className="text-2xl font-bold text-center mb-4">Unique Shades of Magenta</h1>
